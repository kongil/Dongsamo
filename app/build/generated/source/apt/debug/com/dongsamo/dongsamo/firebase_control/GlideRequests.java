...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.dongsamo.dongsamo.firebase_control.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.dongsamo.dongsamo.firebase_control.GlideOptions().apply(toSet));
    }
  }
}
